...
IDEA: str = """DemoFour - a 30 second vertical TikTok/Reels hype video promoting DemoFour,
a tool that lets founders paste their website URL, record 10 seconds of their voice,
and get a polished product demo video in under 60 seconds.
3 scenes:
Scene 1 (The Problem) - A frustrated founder at a laptop late at night, multiple tabs open with freelancer sites and video editors, red notification says 'Demo due tomorrow'. Narration: 'Making a product demo shouldn't take three days, a freelancer, and a prayer.'
Scene 2 (Enter DemoFour) - Clean browser UI, user pastes a URL, taps mic, records 10 seconds, hits Generate. Narration: 'Paste your site. Say ten seconds. Hit generate. That's it.'
Scene 3 (Your Demo Ready) - Finished demo video plays full screen, professional looking, timer shows 00:52. Narration: 'Your demo. Your voice. Under sixty seconds. DemoFour.'
Style: dark, cinematic, electric cyan accents, fast cuts, bold text overlays. Vertical 9:16 format."""
SKIP_DISCOVERY: bool = False
PROJECT_DIR: str = ""

ANCHOR_IMAGE_PATHS_FALLBACK: list[str] = ['anchor_images/demofour_ref.png']
